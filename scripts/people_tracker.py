...
class KalmanMultiTracker:    
    ...
    def __init__(self):      
    	...
    	# ROS publishers
        self.people_pose_pub = rospy.Publisher('people_pose', PoseWithCovArray, queue_size=1000)
        
        self.marker_pub = rospy.Publisher('people_pose_marker', Marker, queue_size=1000)
